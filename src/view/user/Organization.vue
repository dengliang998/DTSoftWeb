<template>
  <div class="organization-container">
    ...
    <el-card class="dept-tree-card">
      <template #header>
        <div class="card-header">
          <span>部门结构</span>
          <el-button type="primary" size="small" :icon="Plus" @click="showAddDeptDialog">
            新增部门
          </el-button>
        </div>
      </template>
    ...
    <el-card class="user-list-card">
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          <el-input clearable placeholder="请输入用户账号或姓名" v-model="queryInfo.query" @clear="getUserList">
            <template #append>
          ...
          <template #default="scope">
            <div class="operation-buttons">
              <el-button type="primary" size="small" :icon="Edit"
                @click="showEditUserDialog(scope.row.Account)"></el-button>
    ...
    <!-- 部门管理对话框 -->
    <el-dialog :title="deptDialogTitle" v-model="deptDialogVisible" width="50%" @close="deptDialogClosed">
      <el-form :model="deptForm" ref="deptFormRef" label-width="100px">
