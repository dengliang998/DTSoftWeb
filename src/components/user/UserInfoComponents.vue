<template>
  <div id="app">
    <!-- 内容主体区域 -->
    <el-form :model="UserForm" ref="UserFormRef" label-width="70px">
      <el-form-item label="头像">
        <el-upload class="avatar-uploader" :action="UploadActionUrl" name="files" :show-file-list="false"
      ...
      <el-form-item label="密码" prop="PassWord" v-if="OpenType === 'New'">
        <el-input show-password v-model="UserForm.PassWord" placeholder="请填写密码"></el-input>
      </el-form-item>
