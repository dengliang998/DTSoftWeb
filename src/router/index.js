  ...
  { path: '/login', component: Login },
  {
    ...
    children: [
      ...
      // 动态应用路由占位符
      {
        path: '/app/:appPath',
        name: 'DynamicAppPage',
        component: () => import('../view/DynamicApp/DynamicAppPage.vue'),
        meta: { cacheName: 'DynamicAppPage' }
      }
    ]
  }
]
